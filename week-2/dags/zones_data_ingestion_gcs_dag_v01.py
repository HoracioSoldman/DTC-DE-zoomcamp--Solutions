...
dataset_base_url = 'https://s3.amazonaws.com/nyc-tlc/misc'
dataset_file = 'taxi+_zone_lookup.csv'
dataset_url = f'{dataset_base_url}/{dataset_file}'
path_to_local_home = os.environ.get("AIRFLOW_HOME", "/opt/airflow/")

dataset_output_file = 'taxi+_zone_lookup.csv'
...
with DAG(
    ...
    description="""
        This dag retrieves Taxi Zone Lookup Table data for the NY Taxi records.
    """, 
    schedule_interval="@once",
    default_args=default_args,
    catchup=False,
    max_active_runs=1,
    tags=['zone lookup', 'NY Taxi'],
) as dag:
